            ...
            <div className="h-full w-full  md:rounded-[20px] shadow-base-shadow bg-white">
                ...
                <div className="information h-[60%]  px-8 py-1 overflow-auto">
                    ...
                    <div className="w-full h-[30%]   grid grid-cols-3">
                        ...
                        justify-around
                        ">
                            <p className="text-truncate w-full text-xl  text-center">เบิกของ</p>
                            <motion.button 
                        ...
                        justify-around 
                        ">
                            <p className="text-truncate w-full text-xl text-center">รายงานปัญหา</p>
                            <motion.button 
